...
namespace DI
{
    public class DIContainer
    {
        ...
        public void RegisterInstance<T>(string tag, T instance)
        {
            ...
            {
                throw new Exception(message:$"DI: Factory with tag {key.Item1} and type {key.Item2.FullName} has already registered");
            }
        ...
        public T Resolve<T>(string tag = null)
        {
            ...
            {
                throw new Exception(message:$"Cyclic dependency for tag {tag} and type {key.Item2.FullName}");
            }
            ...
            throw new Exception(message:$"Couldn't find dependency for tag {tag} and type {key.Item2.FullName}");
        }
